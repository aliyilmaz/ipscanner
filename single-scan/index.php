...
<head>
	<meta charset="utf-8">
	<title>ipscanner | single-scan</title>
...
<body>
	<div class="container" id="area">
		<div class="col-md-12">
			...
			<h3>ipscanner | single-scan</h3>
			<hr>
			<form id="ipscanner">
				<div class="col-md-12">
					<div class="form-group" style="text-align: center;">
						<label>Response Waiting Time</label>
						<input type="text" class="form-control" style="text-align: center; font-weight: bold;" name="wait" placeholder="1 Process Wait Time" value="1">
					</div>
				</div>
